...
*   Driving from Hiroshima City typically takes around 1 hour 30 minutes to 2 hours, depending on traffic.
*   From Osaka or Kobe, the drive is longer, generally 2 hours 30 minutes to 3 hours, also via the Sanyo Expressway.
*   Travelers from Tokyo would typically take the Shinkansen to Shin-Kurashiki (approx. 3.5-4 hours) and then rent a car or take a taxi for the final leg.
